...
public class ProductServiceImpl implements ProductService {
	...
	public void deleteByCID(int cid){ productDao.deleteByCID(cid);}
	@Override
	...
	public void updateAmountAndStoke(int amount,int stoke,int id){ productDao.updateAmountAndStoke(amount,stoke,id);}
}
